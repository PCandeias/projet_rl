...
with tf.Session(config=tf.ConfigProto(
    ...
    print("BASIC TESTS 1:")
    run_test("test6", 100, 100, 100, 100, 0.00000000025)
    run_test("test7", 100, 100, 100, 100, 0.000000025)
    run_test("test8", 100, 100, 100, 100, 0.0000025)
    run_test("test9", 100, 100, 100, 100, 0.00025)
    print("SCARCITY TESTS 1:")
    run_test("test10", 100, 100, 60, 60, 0.00000000025)
    run_test("test11", 100, 100, 60, 60, 0.000000025)
